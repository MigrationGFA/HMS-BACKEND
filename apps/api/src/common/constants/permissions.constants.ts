...
export const PERMISSIONS = {
  ...
  // Master Service Catalog (unified pricing / approval)
  SERVICE_READ: 'service:read',
  SERVICE_CREATE: 'service:create',
  SERVICE_UPDATE: 'service:update',
  SERVICE_PRICE: 'service:price',
  SERVICE_APPROVE: 'service:approve',
  SERVICE_PAYER_MANAGE: 'service_payer:manage',
  ...
  RADIOLOGY_REQUEST_READ: 'radiology-request:read',
  RADIOLOGY_REQUEST_UPDATE: 'radiology-request:update',
  RADIOLOGY_REPORT_CREATE: 'radiology-report:create',
  RADIOLOGY_REPORT_READ: 'radiology-report:read',
  RADIOLOGY_REPORT_VERIFY: 'radiology-report:verify',
  RADIOLOGY_REPORT_RELEASE: 'radiology-report:release',
  ECG_CREATE: 'ecg:create',
  ECG_READ: 'ecg:read',
  ECG_INTERPRET: 'ecg:interpret',
  RADIOLOGY_EQUIPMENT_READ: 'radiology-equipment:read',
  RADIOLOGY_EQUIPMENT_UPDATE: 'radiology-equipment:update',
  RADIOLOGY_FORMS_READ: 'radiology-forms:read',
  RADIOLOGY_FORMS_CREATE: 'radiology-forms:create',
  RADIOLOGY_STUDY_READ: 'radiology-study:read',
  ...
  // Psychiatric OPC
  OPC_READ: 'opc:read',
  OPC_CREATE: 'opc:create',
  OPC_UPDATE: 'opc:update',
  OPC_NOTES_CONFIDENTIAL: 'opc:notes-confidential',
  OPC_EXPORT: 'opc:export',
  ...
  // Cross-module staff communication (Mongo chat)
...
const COMMS_PERMISSIONS: PermissionName[] = [
  PERMISSIONS.COMMS_READ,
  PERMISSIONS.COMMS_SEND,
...
const CLINICAL_READ_PERMISSIONS: PermissionName[] = [
  ...
  PERMISSIONS.PRESCRIPTION_READ,
  /** Prescription safety: interaction checks, alerts, allergies during Rx. */
  PERMISSIONS.CLINICAL_PHARMACY_READ,
  ...
  PERMISSIONS.IMAGING_READ,
  /** Doctors need master service catalog for orderable services. */
  PERMISSIONS.SERVICE_READ,
  PERMISSIONS.TRANSFER_READ,
  PERMISSIONS.NOTIFICATION_READ,
  PERMISSIONS.REFERRAL_READ,
...
const CLINICAL_PERMISSIONS: PermissionName[] = [
  ...
  PERMISSIONS.AUDIT_READ,
  PERMISSIONS.OPC_READ,
  PERMISSIONS.OPC_CREATE,
  PERMISSIONS.OPC_UPDATE,
  PERMISSIONS.OPC_NOTES_CONFIDENTIAL,
  PERMISSIONS.OPC_EXPORT,
];
...
export const ROLE_PERMISSIONS: Partial<Record<RoleName, PermissionName[]>> = {
  ...
  [ROLES.FINANCE]: [
    ...
    PERMISSIONS.ADMISSION_PAY,
    PERMISSIONS.SERVICE_READ,
    PERMISSIONS.SERVICE_PRICE,
    PERMISSIONS.SERVICE_PAYER_MANAGE,
    PERMISSIONS.DISCHARGE_READ,
    PERMISSIONS.DISCHARGE_CLEAR_PAYMENT,
    PERMISSIONS.AUDIT_READ,
    PERMISSIONS.CASHIER_RECEIPT_READ,
  ...
  [ROLES.RADIOLOGY]: [
    ...
    PERMISSIONS.RADIOLOGY_REQUEST_READ,
    PERMISSIONS.RADIOLOGY_REQUEST_UPDATE,
    PERMISSIONS.RADIOLOGY_REPORT_CREATE,
    PERMISSIONS.RADIOLOGY_REPORT_READ,
    PERMISSIONS.RADIOLOGY_REPORT_VERIFY,
    PERMISSIONS.RADIOLOGY_REPORT_RELEASE,
    PERMISSIONS.ECG_CREATE,
    PERMISSIONS.ECG_READ,
    PERMISSIONS.ECG_INTERPRET,
    PERMISSIONS.RADIOLOGY_EQUIPMENT_READ,
    PERMISSIONS.RADIOLOGY_EQUIPMENT_UPDATE,
