...
| Admissions | ✅ | `/api/admissions/*` — wards, beds, admit/transfer/discharge; admit auto-posts package bill |
...
| Records Admission Requests live (approve/reject/admit + Unpaid bill toast) | ✅ |
| Imaging & ECG | 📋 |
